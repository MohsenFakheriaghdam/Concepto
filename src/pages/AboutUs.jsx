		...
		<div className="bg-gray-50 text-gray-800 font-[Vazirmatn]" dir="rtl">
			...
			<section className="py-20 px-6">
				<div className="container mx-auto">
					<h2 className="text-3xl md:text-4xl font-bold mb-16 text-center">با تیم ما آشنا شوید</h2>
					<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
						{/* Team Member 1 */}
						<div className="team-card h-80 rounded-2xl overflow-hidden shadow-lg">
							<div className="team-card-inner relative w-full h-full">
								<div className="team-card-front bg-white w-full h-full absolute">
									<img
									...
									<div className="absolute bottom-0 right-0 left-0 bg-gradient-to-t from-black to-transparent p-4">
										<h3 className="text-white text-xl font-bold">سارا محمدی</h3>
										<p className="text-gray-300">مدیر عامل</p>
									</div>
								</div>
								<div
									className="team-card-back bg-indigo-600 text-white p-6 flex flex-col justify-center absolute w-full h-full"
									style={{ transform: "rotateY(180deg)" }}
								>
									<h3 className="text-xl font-bold mb-2">سارا محمدی</h3>
									<p className="text-sm mb-4">مدیر عامل و بنیانگذار</p>
									<p className="text-sm">"عاشق کوهنوردی هستم و هر سال حداقل 5 قله جدید صعود می‌کنم!"</p>
								</div>
							</div>
						</div>
						{/* Team Member 2 */}
						<div className="team-card h-80 rounded-2xl overflow-hidden shadow-lg">
							<div className="team-card-inner relative w-full h-full">
								<div className="team-card-front bg-white w-full h-full absolute">
									...
									/>
									<div className="absolute bottom-0 right-0 left-0 bg-gradient-to-t from-black to-transparent p-4">
										<h3 className="text-white text-xl font-bold">علی رضایی</h3>
										<p className="text-gray-300">مدیر فناوری</p>
									</div>
								</div>
								<div
									className="team-card-back bg-purple-600 text-white p-6 flex flex-col justify-center absolute w-full h-full"
									style={{ transform: "rotateY(180deg)" }}
								>
									<h3 className="text-xl font-bold mb-2">علی رضایی</h3>
									<p className="text-sm mb-4">مدیر فناوری</p>
									<p className="text-sm">"در وقت آزادم یک بازی موبایلی می‌سازم که تاکنون 10000 بار دانلود شده!"</p>
								</div>
							</div>
						</div>
						{/* Team Member 3 */}
						<div className="team-card h-80 rounded-2xl overflow-hidden shadow-lg">
							<div className="team-card-inner relative w-full h-full">
								<div className="team-card-front bg-white w-full h-full absolute">
									...
									/>
									<div className="absolute bottom-0 right-0 left-0 bg-gradient-to-t from-black to-transparent p-4">
										<h3 className="text-white text-xl font-bold">نازنین حسینی</h3>
										<p className="text-gray-300">مدیر بازاریابی</p>
									</div>
								</div>
								<div
									className="team-card-back bg-blue-600 text-white p-6 flex flex-col justify-center absolute w-full h-full"
									style={{ transform: "rotateY(180deg)" }}
								>
									<h3 className="text-xl font-bold mb-2">نازنین حسینی</h3>
									<p className="text-sm mb-4">مدیر بازاریابی</p>
									<p className="text-sm">"به 3 زبان زنده دنیا مسلط هستم و عاشق یادگیری زبان‌های جدیدم!"</p>
								</div>
							</div>
						</div>
						{/* Team Member 4 */}
						<div className="team-card h-80 rounded-2xl overflow-hidden shadow-lg">
							<div className="team-card-inner relative w-full h-full">
								<div className="team-card-front bg-white w-full h-full absolute">
									...
									/>
									<div className="absolute bottom-0 right-0 left-0 bg-gradient-to-t from-black to-transparent p-4">
										<h3 className="text-white text-xl font-bold">امیر کریمی</h3>
										<p className="text-gray-300">مدیر مالی</p>
									</div>
								</div>
								<div
									className="team-card-back bg-green-600 text-white p-6 flex flex-col justify-center absolute w-full h-full"
									style={{ transform: "rotateY(180deg)" }}
								>
									<h3 className="text-xl font-bold mb-2">امیر کریمی</h3>
									<p className="text-sm mb-4">مدیر مالی</p>
									<p className="text-sm">"در دانشگاه شطرنج حرفه‌ای بازی می‌کردم و چندین مقام ملی دارم!"</p>
								</div>
							</div>
						</div>
					</div>
					<div className="text-center mt-12">
						<button className="bg-indigo-600 hover:bg-indigo-700 text-white px-8 py-3 rounded-full text-lg font-medium transition duration-300 transform hover:scale-105">
							به تیم ما بپیوندید
						</button>
					</div>
				</div>
			...
			<section className="py-20 bg-gray-100">
				<div className="container mx-auto px-6">
					...
					{/* Horizontal Timeline */}
					<div className="timeline-container overflow-x-auto pb-8 flex lg:hidden">
					...
					<div className="hidden lg:block">
						<div className="relative">
							<div className="border-r-2 border-indigo-200 absolute h-full right-1/2"></div>
							{/* ...existing code for vertical timeline items... */}
							{/* You can copy the vertical timeline items from the HTML if needed */}
						</div>
					</div>
				</div>
			</section>
